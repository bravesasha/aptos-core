...
#[rstest(enabled, disabled,
    case(vec![], vec![FeatureFlag::ENUM_TYPES]),
    case(vec![FeatureFlag::ENUM_TYPES], vec![]),
)]
...
#[rstest(enabled, disabled,
    case(vec![], vec![FeatureFlag::RESOURCE_ACCESS_CONTROL]),
    case(vec![FeatureFlag::RESOURCE_ACCESS_CONTROL], vec![]),
)]
