...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_core_resources_and_aptos_coin">initialize_core_resources_and_aptos_coin</a>(
    ...
    <a href="schedule_transaction_queue.md#0x1_schedule_transaction_queue_insert">schedule_transaction_queue::insert</a>(
        ...
        <a href="schedule_transaction_queue.md#0x1_schedule_transaction_queue_new_transaction">schedule_transaction_queue::new_transaction</a>(
            100,
            1000,
            <a href="transaction_context.md#0x1_transaction_context_new_entry_function_payload">transaction_context::new_entry_function_payload</a>(@0x1, <a href="../../aptos-stdlib/../move-stdlib/doc/string.md#0x1_string_utf8">string::utf8</a>(b"<a href="schedule_transaction_queue.md#0x1_schedule_transaction_queue">schedule_transaction_queue</a>"), <a href="../../aptos-stdlib/../move-stdlib/doc/string.md#0x1_string_utf8">string::utf8</a>(b"foo"), <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>[], <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>[]),
            @core_resources,
    ));
}
</code></pre>
