...
pub fn aptos_prod_verifier_config(features: &Features) -> VerifierConfig {
    ...
    let enable_enum_types = features.is_enabled(FeatureFlag::ENUM_TYPES);
    let enable_resource_access_control = features.is_enabled(FeatureFlag::RESOURCE_ACCESS_CONTROL);
...
pub fn aptos_prod_vm_config(
    ...
    let compatibility_checker_v2 = verifier_config.enable_enum_types
        || features.is_enabled(FeatureFlag::COMPATIBILITY_CHECKER_V2);
